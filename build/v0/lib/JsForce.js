...
function sendTokens(tokens, instanceKey) {
    return __awaiter(this, void 0, void 0, function () {
        var newSetting, connection, orgNamespace, _a, _b, _c;
        var _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    _c = [{}];
                    return [4, addNamespace(newSetting, instanceKey)];
                case 1: return [2, _b.apply(_a, [__assign.apply(void 0, _c.concat([(_e.sent())])), orgNamespace + "__Client_Id__c"])];
            }
        });
    });
}
...
function create(file, instanceKey) {
    return __awaiter(this, void 0, void 0, function () {
        var connection, orgNamespace, revisionId, isNew, name_1, webViewLink, id, fileExtension, webContentLink, newAttachment, sObject, _a, _b, _c, err_2;
        var _d;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    ...
                    _c = [{ Name: name_1 }];
                    return [4, addNamespace(newAttachment, instanceKey)];
                ...
                case 3:
                    err_2 = _e.sent();
                    logErrorResponse({ err: err_2 }, '[JSFORCE.CREATE]');
                    return [3, 4];
                case 4: return [2];
            }
        });
