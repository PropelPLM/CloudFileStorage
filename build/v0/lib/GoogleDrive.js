...
var actions = { driveFiles: 'https://www.googleapis.com/auth/drive.file' };
...
function getTokens(code, instanceKey) {
    return __awaiter(this, void 0, void 0, function () {
        var clientId, clientSecret, oAuth2Client;
        var _a;
        return __generator(this, function (_b) {
            (_a = InstanceManager.get(instanceKey, ['clientId', 'clientSecret', 'oAuth2Client']), clientId = _a.clientId, clientSecret = _a.clientSecret, oAuth2Client = _a.oAuth2Client);
            oAuth2Client.getToken(code, function (err, token) {
                JsForce.sendTokens(__assign(__assign({}, token), { clientId: clientId, clientSecret: clientSecret }), instanceKey);
            });
...
function authorize(instanceKey, clientId, clientSecret, tokens) {
    return __awaiter(this, void 0, void 0, function () {
        var oAuth2Client;
...
function initUpload(instanceKey, _a) {
...
function uploadFile(instanceKey, payload) {
    return __awaiter(this, void 0, void 0, function () {
        var uploadStream;
        return __generator(this, function (_a) {
...
function endUpload(instanceKey) {
    return __awaiter(this, void 0, void 0, function () {
        var file;
        return __generator(this, function (_a) {
            switch (_a.label) {
