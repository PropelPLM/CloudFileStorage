...
class GoogleDrive {
    ...
    async authorize(instanceKey, clientId, clientSecret, tokens) {
        try {
    ...
    async initUpload(instanceKey, { fileName, mimeType, fileSize }) {
    ...
    async uploadFile(instanceKey, payload) {
        let uploadStream;
